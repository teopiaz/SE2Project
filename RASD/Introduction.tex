...
\subsection{Stakeholders}\todo[inline]{Matteo: io qui la farei un po' discorsiva visto che sono solo i cittadini (magari anche i turisti)}
\begin{itemize}
	\item Citizens
\end{itemize}
...
\begin{itemize}
	...
	\item \goal{5}
	\item \goal{6}
	\todo{Forse meglio dividere G6 in 2 (una per la request e uno per lo sblocco}
	...
	\todo{[Andrea] Aggiunti G9 e G10, specificano meglio le informazioni riguardanti il servizio del G8-->forse di può togliere G12 e tenerne 2 più specifici}
	\item \goal{11}
