...
%<*9> Allow driver to get discount in base of pick up/parking position of the car, number of passengers and status of the battery.%</9>
%<*10> Allow the system to charge the user with an extra fee if he doesn't pick up a car reserved within an hour from the reservation.%</10>
%<*11> Allow the system to make a car available again after an hour from that car reservation.%</11>
%<*12> Allow the driver to conclude his travel and stop being charged after he turns off and exits the car.%</12>
%<*13> Allow the system to charge the user with an extra fee if he leaves the car at more than 3 km from the nearest power grid station.%</13>
%<*14> Allow the user to put the car in charge when he leaves it in a special parking area.%</14>
